--[[
Kitchen-sink demo for imlove. Run from this directory with:
...
never reach the game: love.mousepressed below checks imlove's return value.
]]
...
-- The course's primary use case: an inspector over a list of plain tables.
